...
import initialState from "states/users"
...
const Users = () => {
    ...
    useEffect(() => {
        getUsers(q, "name", "desc")
    }, [q])

    const getUsers = async (q, sort, dir, page = 0) => {
        if (page === 0) {
            setLoading(true)
        } else {
            setLoadingMore(true)
    ...
    return (
        <DefaultLayout activeItem="users" containerClassName="usersPage">
            <Container>
